...
- Reuse the shared surfaces from [`src/lib/catalogPresentation.ts`](/Users/ericnantes/Developer/RuneFactory/rf4-helper/src/lib/catalogPresentation.ts) before introducing a new panel style.
